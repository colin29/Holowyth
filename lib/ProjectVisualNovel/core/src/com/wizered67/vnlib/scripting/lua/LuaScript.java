...
public class LuaScript extends GameScript {
    ...
    public LuaScript(com.wizered67.vnlib.scripting.lua.LuaScriptManager manager, String script, boolean isFile) {
       if (isFile) {
           FileHandle file = Gdx.files.internal(com.wizered67.vnlib.scripting.lua.LuaScriptManager.SCRIPT_DIRECTORY + script);
