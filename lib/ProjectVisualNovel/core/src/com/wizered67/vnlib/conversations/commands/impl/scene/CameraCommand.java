package com.wizered67.vnlib.conversations.commands.impl.scene;
        ...
        if (positionComponent != null) {
            ...
            if (positionComponent.characterTarget != null) {
                ...
                if (character != null) {
                    ...
                    VNHubManager.error("Character " + positionComponent.characterTarget + " is not in the scene currently.");
                }
            }
