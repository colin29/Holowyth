package com.wizered67.vnlib.gui;
...
import com.wizered67.vnlib.conversations.Transcript;
import com.wizered67.vnlib.conversations.xmlio.ConversationParsingException;
import com.wizered67.vnlib.inputs.Controllable;
...
public class GUIManager implements Controllable {
    ...
    private void initFont() {
        ...
        FreeTypeFontGenerator generator = new FreeTypeFontGenerator(Gdx.files.internal(Assets.ASSETS_DIR + "arial.ttf"));
	...
	public void updateAndRender(float deltaTime){
        conversationController.updateAndRender(deltaTime);
	...
	public void applyViewPortAndDrawStage(float deltaTime) { //this doesn't seem to be needed
	    VNHubManager.guiViewport().apply(true);
