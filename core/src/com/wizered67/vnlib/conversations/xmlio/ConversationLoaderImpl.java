...
import com.wizered67.vnlib.conversations.commands.factories.AssignCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.BackgroundSetFactory;
import com.wizered67.vnlib.conversations.commands.factories.CameraCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.ChangeBranchCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.ChangeConversationCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.CharacterAnimationCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.CharacterNameCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.CharacterVisibleCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.ClearSceneCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.CommandSequenceFactory;
import com.wizered67.vnlib.conversations.commands.factories.ConversationCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.DebugCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.DelayCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.EntityPositionCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.EntityScaleCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.ExecuteScriptCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.ExitCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.LoadUnloadCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.MessageCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.ModifyImageCommandCreatorFactory;
import com.wizered67.vnlib.conversations.commands.factories.PlayMusicCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.PlaySoundCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.ScreenFadeCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.ScreenShakeCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.SetSceneCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.ShowChoicesCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.VariableConditionCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.VariableInitializeCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.VariableWhileCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.WaitForLoadingCommandFactory;
import com.wizered67.vnlib.conversations.commands.factories.WaitUntilVariableCommandFactory;
...
public class ConversationLoaderImpl implements ConversationLoader {
    ...
    public Conversation loadConversation(String name) throws ConversationParsingException {
        FileHandle file = Gdx.files.internal(Assets.ASSETS_DIR + "Conversations/" + name);
