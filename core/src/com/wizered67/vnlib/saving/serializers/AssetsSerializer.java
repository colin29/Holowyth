package com.wizered67.vnlib.saving.serializers;
...
import com.wizered67.vnlib.assets.StoredAssetData;
...
public class AssetsSerializer extends Serializer<Assets> {
    ...
    public Assets read(Kryo kryo, Input input, Class<Assets> type) {
        Assets assets = VNHubManager.assetManager();
        ...
        VNHubManager.assetManager().finishLoading();
        for (StoredAssetData data : loadedAssets) {
