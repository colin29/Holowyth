...
public class TestViewPort extends InputAdapter implements ApplicationListener {
	...
	public boolean touchDown(int screenX, int screenY, int pointer, int button) {
		...
		Vector3 click = viewport.unproject(new Vector3(screenX, screenY, 0)); // get click in world coordinates
